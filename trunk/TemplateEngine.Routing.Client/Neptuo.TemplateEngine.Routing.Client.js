...
var Neptuo$TemplateEngine$Routing$RequestContext = {
    ...
    definition: {
        ctor: function (url, form){
            ...
            this.set_Url(url);
            this.set_Form(form);
            this.set_QueryString(Neptuo.TemplateEngine.Routing.RouteValueDictionary.FromUrl(url));
        },
        Url$$: "System.String",
        get_Url: function (){
            return this._Url;
        ...
        QueryString$$: "Neptuo.TemplateEngine.Routing.RouteValueDictionary",
        ...
        Form$$: "Neptuo.TemplateEngine.Routing.RouteValueDictionary",
        get_Form: function (){
            return this._Form;
        },
    ...
    ctors: [{
        name: "ctor",
        parameters: ["System.String", "Neptuo.TemplateEngine.Routing.RouteValueDictionary"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$TemplateEngine$Routing$Router = {
    ...
    definition: {
        ...
        RouteTo: function (context){
            var $it1 = this.get_Routes().GetEnumerator();
            while ($it1.MoveNext()){
                var route = $it1.get_Current();
    ...
    staticDefinition: {
        FromUrl: function (url){
            ...
            if (index > 0){
                ...
                return Neptuo.TemplateEngine.Routing.RouteValueDictionary.FromQueryString(queryString);
            }
            return new Neptuo.TemplateEngine.Routing.RouteValueDictionary.ctor();
        },
        FromQueryString: function (queryString){
            var result = new Neptuo.TemplateEngine.Routing.RouteValueDictionary.ctor();
            ...
            var $it2 = keyValues.GetEnumerator();
            while ($it2.MoveNext()){
                var keyValue = $it2.get_Current();
