    ...
    public class HostedApplication : HttpApplication
    {
        ...
        protected virtual IDependencyContainer CreateDependencyContainer()
        {
            ...
            dependencyContainer
                ...
                .RegisterInstance<ICommandDispatcher>(new DependencyCommandDispatcher(dependencyContainer, eventManager))
                ...
                .RegisterInstance(commandExecutorFactory)
                .RegisterInstance(interceptorProvider)
                .RegisterInstance<ICommandExecutorFactory>(commandExecutorFactory)
                .RegisterInstance<IInterceptorProvider>(interceptorProvider)
