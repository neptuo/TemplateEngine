...
var Neptuo$TemplateEngine$Templates$CompositeRequestContext = {
    ...
    baseTypeName: "System.Object",
    assemblyName: "Neptuo.TemplateEngine.Templates",
    interfaceNames: ["Neptuo.TemplateEngine.Providers.IRequestContext"],
    Kind: "Class",
    definition: {
    ...
    ctors: [{
        name: "ctor",
        parameters: ["Neptuo.Templates.IComponentManager", "Neptuo.TemplateEngine.Providers.ICurrentUrlProvider", "Neptuo.Templates.IVirtualUrlProvider", "Neptuo.TemplateEngine.Providers.IParameterProviderFactory"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$TemplateEngine$Templates$Controls$GetFormControl = {
    ...
    ctors: [{
        name: "ctor",
        parameters: ["Neptuo.Templates.IComponentManager", "Neptuo.TemplateEngine.Providers.ICurrentUrlProvider"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$TemplateEngine$Templates$Controls$LinkControl = {
    ...
    ctors: [{
        name: "ctor",
        parameters: ["Neptuo.Templates.IComponentManager", "Neptuo.Templates.IVirtualUrlProvider", "Neptuo.TemplateEngine.Providers.ICurrentUrlProvider", "Neptuo.TemplateEngine.Providers.IParameterProviderFactory"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$TemplateEngine$Templates$Controls$PaginationControl = {
    ...
    ctors: [{
        name: "ctor",
        parameters: ["Neptuo.Templates.IComponentManager", "Neptuo.TemplateEngine.Providers.ICurrentUrlProvider", "Neptuo.TemplateEngine.Templates.TemplateContentStorageStack"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$TemplateEngine$Templates$Controls$SelectControlContext = {
    ...
    ctors: [{
        name: "ctor",
        parameters: ["Neptuo.TemplateEngine.Providers.IRequestContext", "Neptuo.TemplateEngine.Templates.TemplateContentStorageStack", "Neptuo.TemplateEngine.Templates.DataContextStorage", "Neptuo.TemplateEngine.Templates.IBindingManager"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$TemplateEngine$Templates$Controls$ContentTemplateContent = {
    ...
    definition: {
        ...
        OnInit: function (){
            if (this.get_Content() != null){
                var $it15 = this.get_Content().GetEnumerator();
                while ($it15.MoveNext()){
...
var Neptuo$TemplateEngine$Templates$ExtendedHtmlTextWriter = {
    ...
    definition: {
        ...
        Tag: function (name){
            ...
            var $it18 = this.get_PendingAttributes().GetEnumerator();
            while ($it18.MoveNext()){
...
var Neptuo$TemplateEngine$Templates$Extensions$CurrentUrlExtension = {
    ...
    ctors: [{
        name: "ctor",
        parameters: ["Neptuo.TemplateEngine.Providers.ICurrentUrlProvider"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$TemplateEngine$Templates$TemplateContentStorage = {
    ...
    definition: {
        ...
        AddRange: function (contents){
            ...
            var $it19 = contents.GetEnumerator();
            while ($it19.MoveNext()){
                var content = $it19.get_Current();
...
var Neptuo$TemplateEngine$Templates$Controls$DetailViewControl = {
    ...
    definition: {
        ...
        Source$$: "Neptuo.TemplateEngine.Templates.DataSources.IClientDataSource",
        get_Source: function (){
            return this._Source;
        },
...
var Neptuo$TemplateEngine$Templates$Controls$ListViewControl = {
    ...
    definition: {
        ...
        Source$$: "Neptuo.TemplateEngine.Templates.DataSources.IClientListDataSource",
        get_Source: function (){
            return this._Source;
        },
        set_Source: function (value){
